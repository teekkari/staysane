...
class ModuleHandler extends React.Component {
    ...
    renderAddNewModule = () => {
        return(
            <div id="add-module" class="fake-module" onClick={this.addNewModule}>
                <svg class="bi bi-plus-circle" width="80px" height="80px" viewBox="0 0 16 16" fill="#aaa" xmlns="http://www.w3.org/2000/svg">
